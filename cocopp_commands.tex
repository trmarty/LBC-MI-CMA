...
Expected running time (\ERT\ in number of $f$-evaluations
                    ...
                    versus dimension. Slanted grid lines indicate quadratic scaling with the dimension. Different symbols correspond to different algorithms given in the legend of #1. Light symbols give the maximum number of evaluations from the longest trial divided by dimension. Some functions are omitted if no algorithm could solve the 20-D problem.  
Legend: 
{\color{CornflowerBlue}$\circ$}: IC-CMA (CMA-ES with integer centering)
, {\color{Orange}$\diamondsuit$}: LB-CMA (CMA-ES with lower bound)
, {\color{Green}$\star$}: \LBCMICMA (CMA-ES with integer centering and lower bound)
, {\color{red}+}: CMA-ES-pycma
, {\color{magenta}$\pentagon$}: CMA-ES with Margin
}

\providecommand{\bbobppalgslegend}[1]{
Legend: 
{\color{CornflowerBlue}$\circ$}: IC-CMA (CMA-ES with integer centering)
, {\color{Orange}$\diamondsuit$}: LB-CMA (CMA-ES with lower bound)
, {\color{Green}$\star$}: \LBCMICMA (CMA-ES with integer centering and lower bound)
...
\providecommand{\algEtables}{\StrLeft{CMA-ESwM Hamano}{\ntables}}
\providecommand{\algDtables}{\StrLeft{CMA-ES-pycma}{\ntables}}
\providecommand{\algCtables}{\StrLeft{IC-LB}{\ntables}}
\providecommand{\algBtables}{\StrLeft{LB}{\ntables}}
\providecommand{\algAtables}{\StrLeft{IC}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\pptablesfooter}{
\end{tabularx}
}
...
\providecommand{\algsfolder}{IC_LB_IC-LB_CMA-E_CMA-E/}
\providecommand{\algorithmA}{CMA-ES-pycma}
\providecommand{\algorithmB}{CMA-ESwM Hamano}
\providecommand{\algorithmC}{IC}
\providecommand{\algorithmD}{IC-LB}
\providecommand{\algorithmE}{LB}
\providecommand{\bbobecdfcaptionsinglefunctionssingledim}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of $f$-evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
...
\providecommand{\algFtables}{\StrLeft{CMA-ESwM Hamano}{\ntables}}
\providecommand{\algEtables}{\StrLeft{CMA-ES-pycma}{\ntables}}
\providecommand{\algDtables}{\StrLeft{exp icclip lb2}{\ntables}}
\providecommand{\algCtables}{\StrLeft{LBx0v5}{\ntables}}
\providecommand{\algBtables}{\StrLeft{exp icclip lb3}{\ntables}}
\providecommand{\algAtables}{\StrLeft{exp ic}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\pptablesfooter}{
\end{tabularx}
}
...
\providecommand{\algsfolder}{exp_i_exp_i_LBx0v_exp_i_CMA-E_CMA-E/}
\providecommand{\algorithmA}{CMA-ES-pycma}
\providecommand{\algorithmB}{CMA-ESwM Hamano}
\providecommand{\algorithmC}{LBx0v5}
\providecommand{\algorithmD}{exp ic}
\providecommand{\algorithmE}{exp icclip lb2}
\providecommand{\algorithmF}{exp icclip lb3}
\providecommand{\bbobecdfcaptionsinglefunctionssingledim}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of $f$-evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
...
\providecommand{\algsfolder}{exp_i_exp_i_LBx0v_CMA-E_CMA-E/}
\providecommand{\algorithmA}{CMA-ES-pycma}
\providecommand{\algorithmB}{CMA-ESwM Hamano}
\providecommand{\algorithmC}{LBx0v5}
\providecommand{\algorithmD}{exp ic}
\providecommand{\algorithmE}{exp icclip lb3}
\providecommand{\bbobpptablesmanylegend}[1]{%
        Expected runtime (\ERT) to reach given targets, measured
        in number of $f$-evaluations, in #1. For each function, the \ERT\ 
        and, in braces as dispersion measure, the half difference between 10 and 
