...
Expected running time (\ERT\ in $\log_{10}$ of number of function evaluations)
        ...
        5:{\color{cyan}+},
        10:{\color{green!45!black}$\triangledown$},
        20:{\color{blue}$\star$},
        40:$\circ$,
        80:{\color{red}$\Box$},
        160:{\color{magenta}$\Diamond$}. 
}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
...
\providecommand{\algBtables}{\StrLeft{CMA-ESwM Hamano}{\ntables}}
\providecommand{\algAtables}{\StrLeft{CMA-ES-pycma}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\pptablesfooter}{
\end{tabularx}
}
...
\providecommand{\algsfolder}{CMA-E_CMA-E/}
...
\providecommand{\algBtables}{\StrLeft{CMA-ESwM Hamano}{\ntables}}
\providecommand{\algAtables}{\StrLeft{IC-CMA}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\pptablesfooter}{
\end{tabularx}
}
...
\providecommand{\algsfolder}{IC-CM_CMA-E/}
\providecommand{\algorithmA}{CMA-ESwM Hamano}
\providecommand{\algorithmB}{IC-CMA}
\providecommand{\bbobecdfcaptionsinglefunctionssingledim}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of $f$-evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
...
\providecommand{\algAtables}{\StrLeft{base-CMA-ES}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\pptablesfooter}{
\end{tabularx}
}
